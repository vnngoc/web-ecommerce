...
const VariantForm = ({
  ...
  let variantTitle = `Variant ${variantIndex + 1}: ${productInput.type} ${productInput.model
    ...
    <>
      ...
      <form onSubmit={handleEditSubmit} className={styles.form_container}>
        ...
        {isEditing && (
          ...
          >
            {sizes.length === 0 && (
              <p className={styles.no_sizes}>Please choose storage.</p>
            )}
            {sizes.length > 0 && (
              <table>
                <thead>
                  <tr>
                    <th>
                      <span className={styles.table_header}>Storage</span>
                    </th>
                    <th>
                          ...
                          <div className={styles.images_button_wrapper}>
                            ...
                            {images.length > 0 && (
                              <>
                                ...
                                {selectedImages.length > 0 && (
                                  <p>{`${selectedImages.length} File${selectedImages.length > 1 ? 's' : ''
                                    } selected`}</p>
                                )}
                                <div>
                                  <Button
