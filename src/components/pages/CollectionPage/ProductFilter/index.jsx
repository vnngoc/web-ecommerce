  ...
  return (
    <>
        ...
        {isModalOpen && (
          <>
            <div className={styles.modal_header}>
              <div
                className={`${styles.option_values_container} ${Object.keys(filterConditions).length > 0
                  ? styles.is_open
                  : undefined
                  }`}
              >
              ...
              <div
                className={`${styles.input_wrapper} ${Object.keys(filterConditions).length > 0
                  ? styles.is_open
                  : undefined
                  }`}
              >
                      ...
                      {(option === 'color' ||
                        ...
                        availableFilterOptions[option]?.map((value) => (
                          <div
                            ...
                            className={`${styles.option_button_value} ${filterConditions[option]?.includes(value)
                              ? styles.is_selected
                              : undefined
                              }`}
                          >
                      ...
                      {option === 'sortBy' &&
                        availableFilterOptions[option]?.map((value) => (
                          <div
                            ...
                            className={`${styles.option_button_value} ${sortByDescription === value
                              ? styles.is_selected
                              : undefined
                              }`}
                          >
      ...
      {isBigScreen && (
        ...
        >
          <div
            className={`${styles.option_buttons_container} ${showOption ? styles.is_open : undefined
              }`}
          >
            <div className={styles.expandable}>
              <div className={styles.option_buttons_wrapper}>
                  ...
                  {(showOption === 'color' ||
                    ...
                    availableFilterOptions[showOption]?.map((value) => (
                      <div
                        ...
                        className={`${styles.option_button_value} ${filterConditions[showOption]?.includes(value)
                          ? styles.is_selected
                          : undefined
                          }`}
                      >
          ...
          <ul
            className={`${styles.options} ${showOption ? styles.option_is_selected : undefined
          ...
          >
            <li
              ...
              className={`${styles.option} ${showOption === 'color' ? styles.is_selected : undefined
                }`}
            >
              <span>Color</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'size' ? styles.is_selected : undefined
                }`}
            >
              <span>Size</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'fit' ? styles.is_selected : undefined
                }`}
            >
              <span>Name</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'type' ? styles.is_selected : undefined
                }`}
            >
              <span>Type</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'price' ? styles.is_selected : undefined
                }`}
            >
              <span>Price</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'discount' ? styles.is_selected : undefined
                }`}
            >
              <span>Discount</span>
              <FaChevronUp />
            ...
            <li
              ...
              className={`${styles.option} ${showOption === 'sort-by' ? styles.is_selected : undefined
                }`}
            >
